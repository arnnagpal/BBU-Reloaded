    ...
    public void run() {
        while (true) {
            ...
            if (time > 0) {
                ...
                for (Player player : Bukkit.getOnlinePlayers()) {
                    player.showTitle(Title.title(CC.translate("&a&lGO!"), CC.translate("&7Good luck, have fun!"), Title.Times.times(Duration.ofMillis(500), Duration.ofSeconds(2), Duration.ofMillis(500))));
